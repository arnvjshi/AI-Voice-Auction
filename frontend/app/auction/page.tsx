      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-4">
              <Badge
                variant="outline"
                className="px-4 py-2 bg-green-50 dark:bg-green-950/20 border-green-200 dark:border-green-800"
              >
              ...
              <Badge
                variant="outline"
                className="px-4 py-2 bg-blue-50 dark:bg-blue-950/20 border-blue-200 dark:border-blue-800"
              >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          {[
            ...
            <Card
              key={index}
              className="bg-gradient-to-br from-card to-muted/20 border-0 shadow-md hover:shadow-lg transition-all"
            >
